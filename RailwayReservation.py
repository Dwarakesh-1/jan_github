...
class acceptors:
    ...
    def accept_train_number():
        ...
        try:
            ...
            print("Please enter the correct train number!!")
    ...
    def accept_coach():
        ...
        coach = coach.upper()
        if coach not in ('SL', '1AC', '2AC'):
            print("Please enter a valid coach number!!")
    ...
    def accept_ticket_num():
        ...
        try:
            ...
            print("Enter the correct number of tickets required!!")
...
def book_ticket():
    ...
    trains[choice].print_seat_avilability()
    ...
    if trains[choice].check_availability(coach, ticket_num):
        ...
        if prompt == 'Y':
            ...
            tick = ticket(trans[choice], users[uid], ticket_num, coach)
            print("Please note down the PNR number :- ", tick.pnr, "\n\n")
            menu()
        else:
            print("Exiting......\n\n")
            menu()
...
def cancel_ticket():
    ...
    if pnr in ticket_dict:
        ...
        if prompt == 'Y':
            ...
            print("\n Tickets are not cancelled \n")
    menu()

def check_seat_availabilty(flag = ''):
    src = input("Enter the name of Source station :- ")
    des = input("Enter the name of destination station :- ")
    flag_2 = 0
    for i in trains:
        if trains[i].src == src and trains[i].des == des:
            ...
            flag_2 += 1
    if flag_2 == 0:
        print("\n Number of trains found between the stations you entered \n")
        menu()
    if flag == '':
...
def check_pnr(pnr = ''):
    if pnr == '':
        ...
        print("Number of Tickets Booked :- ", ticket_dict[pnr].ticket_num)
        print()
        menu()
    else:
        print()
...
t1 = train('Odisha', 12345, '12:35', '22:12', 'CTC', 'KGP', 'Wed', 30, 23, 43, 2205, 320, 234)
t2 = train('Howrah', 12356, '01:57', '22:58', 'HWR', 'KOL', 'Mon', 33, 4, 12, 3434, 435, 224)
t3 = train('Bengaluru', 24578, '13:10', '05:50', 'CTC', 'BAN', 'Fri', 33, 24, 77, 465, 335, 546)
trains = {t1.num : t1, t2.num : t2, t3.num : t3}
u1 = user(1456, 'Raj', 'Pune', '7013645782', 'Ranu')
u2 = user(7825, 'Green Jones', 'New Jersey', '9786453120', 'Creanli')
...
print("_" * 40, "Welcome to Railway Reservation Portal", "_" * 40)
print("_" * 95)
load()
...
def menu():
    ...
    print("3. Check PNR")
    print("4. Check for seat availability")
    print("5. Create new account")
    print("6. Check for previous bookings")
    print("7. Login")
    print("8. Exit/Leave")
